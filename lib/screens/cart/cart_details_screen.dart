        ...
        bottomNavigationBar: Column(
          ...
          children: [
            Container(
              // color: Colors.red,
              padding:
                  const EdgeInsets.symmetric(vertical: 10, horizontal: 30).r,
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  MyCustomIconButton(
                    icon: Icons.remove,
                    function: () {
                      cartController.addItem(eachProduct, -1);
                    },
                  ...
                  BigText(
                    // text: "abc",
                    text:
                        "\$ ${eachProduct.price} X ${cartController.getQuantity(product: eachProduct)}",
                    color: Colors.black,
                    size: 20.sp,
                  ),
                  MyCustomIconButton(
